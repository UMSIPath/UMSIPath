<header>
    	<div id="header-wrap">
        	<div id="logo">
            	<a href="http://localhost:8888/umsipath/v1/index.php"><img src="http://localhost:8888/umsipath/v1/static/images/umsi-discover-logo.png" name="UMSI/Discover logo" alt="UMSI/Discover logo"/></a>
            </div>
            ...
            <nav>
            	<ul>
                	<li><a href="http://localhost:8888/umsipath/v1/index.php">Home</a></li>
                    <li><a href="#">Discover</a>
                    	<ul>
                        	<li><a href="http://localhost:8888/umsipath/v1/skills/search.php"><h1>Find Courses by Skills</h1><p>You choose skills, we find you courses</p></a></li>
							<li><a href="../careers/search.php"><h1>Find Courses by Careers</h1><p>You choose careers, we find you courses</p></a></li>
						</ul>
                    </li>
                    <li><a href="#">Browse</a>
                    	<ul>
                        	<li><a href="#"><h1>All Courses</h1></a></li>
